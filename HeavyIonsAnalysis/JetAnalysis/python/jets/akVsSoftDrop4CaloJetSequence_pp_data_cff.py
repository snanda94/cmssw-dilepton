...
#ppDataDummy_akVsSoftDrop4CalopatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop4CaloNjettiness:tau1','akVsSoftDrop4CaloNjettiness:tau2','akVsSoftDrop4CaloNjettiness:tau3']
...
akVsSoftDrop4CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsSoftDrop4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsSoftDrop4CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsSoftDrop4CaloJetSequence_data = cms.Sequence(akVsSoftDrop4Calocorr
                                                    ...
                                                    *
                                                    akVsSoftDrop4CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsSoftDrop4CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsSoftDrop4CalopatJetsWithBtagging
                                                    *
                                                    akVsSoftDrop4CaloJetAnalyzer
