...
#ppDataDummy_akVs3PFpatJetsWithBtagging.userData.userFloats.src += ['akVs3PFNjettiness:tau1','akVs3PFNjettiness:tau2','akVs3PFNjettiness:tau3']
...
akVs3PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVs3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akVs3PFJetBtagging
                                                  *
                                                  #ppDataDummy_akVs3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
