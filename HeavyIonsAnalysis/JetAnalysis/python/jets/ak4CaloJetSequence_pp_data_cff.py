...
ak4CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          ak4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  ak4CaloJetBtagging
                                                  *
                                                  #ppDataDummy_ak4CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
