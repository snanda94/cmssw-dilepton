...
#ppDataDummy_akPuFilter4CalopatJetsWithBtagging.userData.userFloats.src += ['akPuFilter4CaloNjettiness:tau1','akPuFilter4CaloNjettiness:tau2','akPuFilter4CaloNjettiness:tau3']
...
akPuFilter4CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter4CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter4CaloJetSequence_data = cms.Sequence(akPuFilter4Calocorr
                                                    ...
                                                    *
                                                    akPuFilter4CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter4CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter4CalopatJetsWithBtagging
                                                    *
                                                    akPuFilter4CaloJetAnalyzer
