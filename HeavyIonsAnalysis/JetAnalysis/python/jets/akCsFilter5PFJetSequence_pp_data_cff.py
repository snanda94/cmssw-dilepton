...
#ppDataDummy_akCsFilter5PFpatJetsWithBtagging.userData.userFloats.src += ['akCsFilter5PFNjettiness:tau1','akCsFilter5PFNjettiness:tau2','akCsFilter5PFNjettiness:tau3']
...
akCsFilter5PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akCsFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akCsFilter5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akCsFilter5PFJetSequence_data = cms.Sequence(akCsFilter5PFcorr
                                                    ...
                                                    *
                                                    akCsFilter5PFJetBtagging
                                                    *
                                                    #ppDataDummy_akCsFilter5PFNjettiness 
                                                    #ppDataDummy_*
                                                    akCsFilter5PFpatJetsWithBtagging
                                                    *
                                                    akCsFilter5PFJetAnalyzer
