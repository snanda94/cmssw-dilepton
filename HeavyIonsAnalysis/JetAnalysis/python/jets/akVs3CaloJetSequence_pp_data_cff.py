...
#ppDataDummy_akVs3CalopatJetsWithBtagging.userData.userFloats.src += ['akVs3CaloNjettiness:tau1','akVs3CaloNjettiness:tau2','akVs3CaloNjettiness:tau3']
...
akVs3CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVs3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVs3CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVs3CaloJetSequence_data = cms.Sequence(akVs3Calocorr
                                                    ...
                                                    *
                                                    akVs3CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVs3CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVs3CalopatJetsWithBtagging
                                                    *
                                                    akVs3CaloJetAnalyzer
