...
#ppDataDummy_akPuFilter1CalopatJetsWithBtagging.userData.userFloats.src += ['akPuFilter1CaloNjettiness:tau1','akPuFilter1CaloNjettiness:tau2','akPuFilter1CaloNjettiness:tau3']
...
akPuFilter1CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter1CaloJetSequence_data = cms.Sequence(akPuFilter1Calocorr
                                                    ...
                                                    *
                                                    akPuFilter1CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter1CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter1CalopatJetsWithBtagging
                                                    *
                                                    akPuFilter1CaloJetAnalyzer
