...
#ppDataDummy_akVsFilter4CalopatJetsWithBtagging.userData.userFloats.src += ['akVsFilter4CaloNjettiness:tau1','akVsFilter4CaloNjettiness:tau2','akVsFilter4CaloNjettiness:tau3']
...
akVsFilter4CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter4CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter4CaloJetSequence_data = cms.Sequence(akVsFilter4Calocorr
                                                    ...
                                                    *
                                                    akVsFilter4CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter4CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter4CalopatJetsWithBtagging
                                                    *
                                                    akVsFilter4CaloJetAnalyzer
