...
#ppDataDummy_akPuFilter5PFpatJetsWithBtagging.userData.userFloats.src += ['akPuFilter5PFNjettiness:tau1','akPuFilter5PFNjettiness:tau2','akPuFilter5PFNjettiness:tau3']
...
akPuFilter5PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter5PFJetSequence_data = cms.Sequence(akPuFilter5PFcorr
                                                    ...
                                                    *
                                                    akPuFilter5PFJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter5PFNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter5PFpatJetsWithBtagging
                                                    *
                                                    akPuFilter5PFJetAnalyzer
