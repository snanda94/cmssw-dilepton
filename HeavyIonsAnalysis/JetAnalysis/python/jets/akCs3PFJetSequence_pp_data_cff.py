...
#ppDataDummy_akCs3PFpatJetsWithBtagging.userData.userFloats.src += ['akCs3PFNjettiness:tau1','akCs3PFNjettiness:tau2','akCs3PFNjettiness:tau3']
...
akCs3PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akCs3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akCs3PFJetBtagging
                                                  *
                                                  #ppDataDummy_akCs3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
