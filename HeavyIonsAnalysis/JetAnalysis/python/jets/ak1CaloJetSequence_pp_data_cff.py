...
ak1CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          ak1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  ak1CaloJetBtagging
                                                  *
                                                  #ppDataDummy_ak1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
