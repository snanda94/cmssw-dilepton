...
#ppDataDummy_akVsFilter3CalopatJetsWithBtagging.userData.userFloats.src += ['akVsFilter3CaloNjettiness:tau1','akVsFilter3CaloNjettiness:tau2','akVsFilter3CaloNjettiness:tau3']
...
akVsFilter3CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter3CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter3CaloJetSequence_data = cms.Sequence(akVsFilter3Calocorr
                                                    ...
                                                    *
                                                    akVsFilter3CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter3CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter3CalopatJetsWithBtagging
                                                    *
                                                    akVsFilter3CaloJetAnalyzer
