...
#ppDataDummy_akPuFilter4PFpatJetsWithBtagging.userData.userFloats.src += ['akPuFilter4PFNjettiness:tau1','akPuFilter4PFNjettiness:tau2','akPuFilter4PFNjettiness:tau3']
...
akPuFilter4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter4PFJetSequence_data = cms.Sequence(akPuFilter4PFcorr
                                                    ...
                                                    *
                                                    akPuFilter4PFJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter4PFNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter4PFpatJetsWithBtagging
                                                    *
                                                    akPuFilter4PFJetAnalyzer
