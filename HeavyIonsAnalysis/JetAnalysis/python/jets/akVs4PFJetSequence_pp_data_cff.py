...
#ppDataDummy_akVs4PFpatJetsWithBtagging.userData.userFloats.src += ['akVs4PFNjettiness:tau1','akVs4PFNjettiness:tau2','akVs4PFNjettiness:tau3']
...
akVs4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVs4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akVs4PFJetBtagging
                                                  *
                                                  #ppDataDummy_akVs4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
