...
#ppDataDummy_akPuFilter3PFpatJetsWithBtagging.userData.userFloats.src += ['akPuFilter3PFNjettiness:tau1','akPuFilter3PFNjettiness:tau2','akPuFilter3PFNjettiness:tau3']
...
akPuFilter3PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter3PFJetSequence_data = cms.Sequence(akPuFilter3PFcorr
                                                    ...
                                                    *
                                                    akPuFilter3PFJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter3PFNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter3PFpatJetsWithBtagging
                                                    *
                                                    akPuFilter3PFJetAnalyzer
