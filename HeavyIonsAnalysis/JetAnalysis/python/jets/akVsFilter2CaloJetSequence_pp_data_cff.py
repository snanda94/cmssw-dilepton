...
#ppDataDummy_akVsFilter2CalopatJetsWithBtagging.userData.userFloats.src += ['akVsFilter2CaloNjettiness:tau1','akVsFilter2CaloNjettiness:tau2','akVsFilter2CaloNjettiness:tau3']
...
akVsFilter2CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter2CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter2CaloJetSequence_data = cms.Sequence(akVsFilter2Calocorr
                                                    ...
                                                    *
                                                    akVsFilter2CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter2CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter2CalopatJetsWithBtagging
                                                    *
                                                    akVsFilter2CaloJetAnalyzer
