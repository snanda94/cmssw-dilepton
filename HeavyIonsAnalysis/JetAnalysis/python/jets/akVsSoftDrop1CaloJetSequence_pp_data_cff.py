...
#ppDataDummy_akVsSoftDrop1CalopatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop1CaloNjettiness:tau1','akVsSoftDrop1CaloNjettiness:tau2','akVsSoftDrop1CaloNjettiness:tau3']
...
akVsSoftDrop1CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsSoftDrop1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsSoftDrop1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsSoftDrop1CaloJetSequence_data = cms.Sequence(akVsSoftDrop1Calocorr
                                                    ...
                                                    *
                                                    akVsSoftDrop1CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsSoftDrop1CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsSoftDrop1CalopatJetsWithBtagging
                                                    *
                                                    akVsSoftDrop1CaloJetAnalyzer
