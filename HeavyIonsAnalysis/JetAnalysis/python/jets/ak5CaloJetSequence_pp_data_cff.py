...
#ppDataDummy_ak5CalopatJetsWithBtagging.userData.userFloats.src += ['ak5CaloNjettiness:tau1','ak5CaloNjettiness:tau2','ak5CaloNjettiness:tau3']
...
ak5CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          ak5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  ak5CaloJetBtagging
                                                  *
                                                  #ppDataDummy_ak5CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
