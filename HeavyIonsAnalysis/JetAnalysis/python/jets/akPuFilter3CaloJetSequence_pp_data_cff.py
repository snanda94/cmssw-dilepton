...
#ppDataDummy_akPuFilter3CalopatJetsWithBtagging.userData.userFloats.src += ['akPuFilter3CaloNjettiness:tau1','akPuFilter3CaloNjettiness:tau2','akPuFilter3CaloNjettiness:tau3']
...
akPuFilter3CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter3CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter3CaloJetSequence_data = cms.Sequence(akPuFilter3Calocorr
                                                    ...
                                                    *
                                                    akPuFilter3CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter3CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter3CalopatJetsWithBtagging
                                                    *
                                                    akPuFilter3CaloJetAnalyzer
