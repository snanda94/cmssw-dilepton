...
akFilter1CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akFilter1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akFilter1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akFilter1CaloJetSequence_data = cms.Sequence(akFilter1Calocorr
                                                    ...
                                                    *
                                                    akFilter1CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akFilter1CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akFilter1CalopatJetsWithBtagging
                                                    *
                                                    akFilter1CaloJetAnalyzer
