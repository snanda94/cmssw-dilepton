...
#ppDataDummy_akPuFilter2PFpatJetsWithBtagging.userData.userFloats.src += ['akPuFilter2PFNjettiness:tau1','akPuFilter2PFNjettiness:tau2','akPuFilter2PFNjettiness:tau3']
...
akPuFilter2PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter2PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter2PFJetSequence_data = cms.Sequence(akPuFilter2PFcorr
                                                    ...
                                                    *
                                                    akPuFilter2PFJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter2PFNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter2PFpatJetsWithBtagging
                                                    *
                                                    akPuFilter2PFJetAnalyzer
