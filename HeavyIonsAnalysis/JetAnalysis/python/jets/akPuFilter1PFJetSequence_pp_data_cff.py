...
#ppDataDummy_akPuFilter1PFpatJetsWithBtagging.userData.userFloats.src += ['akPuFilter1PFNjettiness:tau1','akPuFilter1PFNjettiness:tau2','akPuFilter1PFNjettiness:tau3']
...
akPuFilter1PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter1PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter1PFJetSequence_data = cms.Sequence(akPuFilter1PFcorr
                                                    ...
                                                    *
                                                    akPuFilter1PFJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter1PFNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter1PFpatJetsWithBtagging
                                                    *
                                                    akPuFilter1PFJetAnalyzer
