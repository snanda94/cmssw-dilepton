...
akFilter4CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akFilter4CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akFilter4CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akFilter4CaloJetSequence_data = cms.Sequence(akFilter4Calocorr
                                                    ...
                                                    *
                                                    akFilter4CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akFilter4CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akFilter4CalopatJetsWithBtagging
                                                    *
                                                    akFilter4CaloJetAnalyzer
