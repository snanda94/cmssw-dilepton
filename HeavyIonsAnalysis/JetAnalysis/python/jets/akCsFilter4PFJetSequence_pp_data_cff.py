...
#ppDataDummy_akCsFilter4PFpatJetsWithBtagging.userData.userFloats.src += ['akCsFilter4PFNjettiness:tau1','akCsFilter4PFNjettiness:tau2','akCsFilter4PFNjettiness:tau3']
...
akCsFilter4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akCsFilter4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akCsFilter4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akCsFilter4PFJetSequence_data = cms.Sequence(akCsFilter4PFcorr
                                                    ...
                                                    *
                                                    akCsFilter4PFJetBtagging
                                                    *
                                                    #ppDataDummy_akCsFilter4PFNjettiness 
                                                    #ppDataDummy_*
                                                    akCsFilter4PFpatJetsWithBtagging
                                                    *
                                                    akCsFilter4PFJetAnalyzer
