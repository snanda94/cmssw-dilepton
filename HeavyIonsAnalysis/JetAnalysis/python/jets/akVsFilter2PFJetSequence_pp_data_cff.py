...
#ppDataDummy_akVsFilter2PFpatJetsWithBtagging.userData.userFloats.src += ['akVsFilter2PFNjettiness:tau1','akVsFilter2PFNjettiness:tau2','akVsFilter2PFNjettiness:tau3']
...
akVsFilter2PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter2PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter2PFJetSequence_data = cms.Sequence(akVsFilter2PFcorr
                                                    ...
                                                    *
                                                    akVsFilter2PFJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter2PFNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter2PFpatJetsWithBtagging
                                                    *
                                                    akVsFilter2PFJetAnalyzer
