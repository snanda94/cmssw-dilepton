...
#ppDataDummy_akVsSoftDrop3PFpatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop3PFNjettiness:tau1','akVsSoftDrop3PFNjettiness:tau2','akVsSoftDrop3PFNjettiness:tau3']
...
akVsSoftDrop3PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsSoftDrop3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsSoftDrop3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsSoftDrop3PFJetSequence_data = cms.Sequence(akVsSoftDrop3PFcorr
                                                    ...
                                                    *
                                                    akVsSoftDrop3PFJetBtagging
                                                    *
                                                    #ppDataDummy_akVsSoftDrop3PFNjettiness 
                                                    #ppDataDummy_*
                                                    akVsSoftDrop3PFpatJetsWithBtagging
                                                    *
                                                    akVsSoftDrop3PFJetAnalyzer
