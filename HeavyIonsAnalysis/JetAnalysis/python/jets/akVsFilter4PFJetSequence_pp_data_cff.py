...
#ppDataDummy_akVsFilter4PFpatJetsWithBtagging.userData.userFloats.src += ['akVsFilter4PFNjettiness:tau1','akVsFilter4PFNjettiness:tau2','akVsFilter4PFNjettiness:tau3']
...
akVsFilter4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter4PFJetSequence_data = cms.Sequence(akVsFilter4PFcorr
                                                    ...
                                                    *
                                                    akVsFilter4PFJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter4PFNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter4PFpatJetsWithBtagging
                                                    *
                                                    akVsFilter4PFJetAnalyzer
