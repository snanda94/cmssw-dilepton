...
#ppDataDummy_akVsSoftDrop2CalopatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop2CaloNjettiness:tau1','akVsSoftDrop2CaloNjettiness:tau2','akVsSoftDrop2CaloNjettiness:tau3']
...
akVsSoftDrop2CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsSoftDrop2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsSoftDrop2CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsSoftDrop2CaloJetSequence_data = cms.Sequence(akVsSoftDrop2Calocorr
                                                    ...
                                                    *
                                                    akVsSoftDrop2CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsSoftDrop2CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsSoftDrop2CalopatJetsWithBtagging
                                                    *
                                                    akVsSoftDrop2CaloJetAnalyzer
