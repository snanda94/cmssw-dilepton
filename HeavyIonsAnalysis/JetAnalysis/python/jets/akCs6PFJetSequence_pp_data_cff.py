...
#ppDataDummy_akCs6PFpatJetsWithBtagging.userData.userFloats.src += ['akCs6PFNjettiness:tau1','akCs6PFNjettiness:tau2','akCs6PFNjettiness:tau3']
...
akCs6PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akCs6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akCs6PFJetBtagging
                                                  *
                                                  #ppDataDummy_akCs6PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
