...
#ppDataDummy_akPu4PFpatJetsWithBtagging.userData.userFloats.src += ['akPu4PFNjettiness:tau1','akPu4PFNjettiness:tau2','akPu4PFNjettiness:tau3']
...
akPu4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPu4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akPu4PFJetBtagging
                                                  *
                                                  #ppDataDummy_akPu4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
