...
#ppDataDummy_akCsFilter1PFpatJetsWithBtagging.userData.userFloats.src += ['akCsFilter1PFNjettiness:tau1','akCsFilter1PFNjettiness:tau2','akCsFilter1PFNjettiness:tau3']
...
akCsFilter1PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akCsFilter1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akCsFilter1PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akCsFilter1PFJetSequence_data = cms.Sequence(akCsFilter1PFcorr
                                                    ...
                                                    *
                                                    akCsFilter1PFJetBtagging
                                                    *
                                                    #ppDataDummy_akCsFilter1PFNjettiness 
                                                    #ppDataDummy_*
                                                    akCsFilter1PFpatJetsWithBtagging
                                                    *
                                                    akCsFilter1PFJetAnalyzer
