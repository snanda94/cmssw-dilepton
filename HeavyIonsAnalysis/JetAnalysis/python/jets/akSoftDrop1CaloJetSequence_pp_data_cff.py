...
akSoftDrop1CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akSoftDrop1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akSoftDrop1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akSoftDrop1CaloJetSequence_data = cms.Sequence(akSoftDrop1Calocorr
                                                    ...
                                                    *
                                                    akSoftDrop1CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akSoftDrop1CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akSoftDrop1CalopatJetsWithBtagging
                                                    *
                                                    akSoftDrop1CaloJetAnalyzer
