...
#ppDataDummy_akPuFilter2CalopatJetsWithBtagging.userData.userFloats.src += ['akPuFilter2CaloNjettiness:tau1','akPuFilter2CaloNjettiness:tau2','akPuFilter2CaloNjettiness:tau3']
...
akPuFilter2CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter2CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter2CaloJetSequence_data = cms.Sequence(akPuFilter2Calocorr
                                                    ...
                                                    *
                                                    akPuFilter2CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter2CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter2CalopatJetsWithBtagging
                                                    *
                                                    akPuFilter2CaloJetAnalyzer
