...
#ppDataDummy_akPuFilter6CalopatJetsWithBtagging.userData.userFloats.src += ['akPuFilter6CaloNjettiness:tau1','akPuFilter6CaloNjettiness:tau2','akPuFilter6CaloNjettiness:tau3']
...
akPuFilter6CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter6CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter6CaloJetSequence_data = cms.Sequence(akPuFilter6Calocorr
                                                    ...
                                                    *
                                                    akPuFilter6CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter6CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter6CalopatJetsWithBtagging
                                                    *
                                                    akPuFilter6CaloJetAnalyzer
