...
akFilter3CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akFilter3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akFilter3CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akFilter3CaloJetSequence_data = cms.Sequence(akFilter3Calocorr
                                                    ...
                                                    *
                                                    akFilter3CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akFilter3CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akFilter3CalopatJetsWithBtagging
                                                    *
                                                    akFilter3CaloJetAnalyzer
