...
#ppDataDummy_akVs2CalopatJetsWithBtagging.userData.userFloats.src += ['akVs2CaloNjettiness:tau1','akVs2CaloNjettiness:tau2','akVs2CaloNjettiness:tau3']
...
akVs2CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVs2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVs2CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVs2CaloJetSequence_data = cms.Sequence(akVs2Calocorr
                                                    ...
                                                    *
                                                    akVs2CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVs2CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVs2CalopatJetsWithBtagging
                                                    *
                                                    akVs2CaloJetAnalyzer
