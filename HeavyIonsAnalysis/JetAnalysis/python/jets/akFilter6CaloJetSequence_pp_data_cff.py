...
akFilter6CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akFilter6CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akFilter6CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akFilter6CaloJetSequence_data = cms.Sequence(akFilter6Calocorr
                                                    ...
                                                    *
                                                    akFilter6CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akFilter6CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akFilter6CalopatJetsWithBtagging
                                                    *
                                                    akFilter6CaloJetAnalyzer
