...
#ppDataDummy_akVsFilter3PFpatJetsWithBtagging.userData.userFloats.src += ['akVsFilter3PFNjettiness:tau1','akVsFilter3PFNjettiness:tau2','akVsFilter3PFNjettiness:tau3']
...
akVsFilter3PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter3PFJetSequence_data = cms.Sequence(akVsFilter3PFcorr
                                                    ...
                                                    *
                                                    akVsFilter3PFJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter3PFNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter3PFpatJetsWithBtagging
                                                    *
                                                    akVsFilter3PFJetAnalyzer
