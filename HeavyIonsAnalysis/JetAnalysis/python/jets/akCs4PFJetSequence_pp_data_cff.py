...
#ppDataDummy_akCs4PFpatJetsWithBtagging.userData.userFloats.src += ['akCs4PFNjettiness:tau1','akCs4PFNjettiness:tau2','akCs4PFNjettiness:tau3']
...
akCs4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akCs4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akCs4PFJetBtagging
                                                  *
                                                  #ppDataDummy_akCs4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
