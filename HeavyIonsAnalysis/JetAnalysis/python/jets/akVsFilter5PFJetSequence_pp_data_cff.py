...
#ppDataDummy_akVsFilter5PFpatJetsWithBtagging.userData.userFloats.src += ['akVsFilter5PFNjettiness:tau1','akVsFilter5PFNjettiness:tau2','akVsFilter5PFNjettiness:tau3']
...
akVsFilter5PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter5PFJetSequence_data = cms.Sequence(akVsFilter5PFcorr
                                                    ...
                                                    *
                                                    akVsFilter5PFJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter5PFNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter5PFpatJetsWithBtagging
                                                    *
                                                    akVsFilter5PFJetAnalyzer
