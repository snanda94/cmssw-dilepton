...
#ppDataDummy_akVsFilter1PFpatJetsWithBtagging.userData.userFloats.src += ['akVsFilter1PFNjettiness:tau1','akVsFilter1PFNjettiness:tau2','akVsFilter1PFNjettiness:tau3']
...
akVsFilter1PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter1PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter1PFJetSequence_data = cms.Sequence(akVsFilter1PFcorr
                                                    ...
                                                    *
                                                    akVsFilter1PFJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter1PFNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter1PFpatJetsWithBtagging
                                                    *
                                                    akVsFilter1PFJetAnalyzer
