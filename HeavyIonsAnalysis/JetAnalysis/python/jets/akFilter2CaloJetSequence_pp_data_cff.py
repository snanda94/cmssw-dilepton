...
akFilter2CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akFilter2CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akFilter2CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akFilter2CaloJetSequence_data = cms.Sequence(akFilter2Calocorr
                                                    ...
                                                    *
                                                    akFilter2CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akFilter2CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akFilter2CalopatJetsWithBtagging
                                                    *
                                                    akFilter2CaloJetAnalyzer
