...
#ppDataDummy_akVsFilter1CalopatJetsWithBtagging.userData.userFloats.src += ['akVsFilter1CaloNjettiness:tau1','akVsFilter1CaloNjettiness:tau2','akVsFilter1CaloNjettiness:tau3']
...
akVsFilter1CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter1CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter1CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter1CaloJetSequence_data = cms.Sequence(akVsFilter1Calocorr
                                                    ...
                                                    *
                                                    akVsFilter1CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter1CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter1CalopatJetsWithBtagging
                                                    *
                                                    akVsFilter1CaloJetAnalyzer
