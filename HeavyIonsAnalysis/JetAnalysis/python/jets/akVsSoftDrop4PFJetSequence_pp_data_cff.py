...
#ppDataDummy_akVsSoftDrop4PFpatJetsWithBtagging.userData.userFloats.src += ['akVsSoftDrop4PFNjettiness:tau1','akVsSoftDrop4PFNjettiness:tau2','akVsSoftDrop4PFNjettiness:tau3']
...
akVsSoftDrop4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsSoftDrop4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsSoftDrop4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsSoftDrop4PFJetSequence_data = cms.Sequence(akVsSoftDrop4PFcorr
                                                    ...
                                                    *
                                                    akVsSoftDrop4PFJetBtagging
                                                    *
                                                    #ppDataDummy_akVsSoftDrop4PFNjettiness 
                                                    #ppDataDummy_*
                                                    akVsSoftDrop4PFpatJetsWithBtagging
                                                    *
                                                    akVsSoftDrop4PFJetAnalyzer
