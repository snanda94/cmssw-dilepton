...
ak5PFJetSequence_mc = cms.Sequence(
			                          ...
			                          ak5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  ak5PFJetBtagging
                                                  *
                                                  #ppDataDummy_ak5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
