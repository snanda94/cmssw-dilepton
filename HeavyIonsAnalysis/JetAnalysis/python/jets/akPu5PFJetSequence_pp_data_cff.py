...
#ppDataDummy_akPu5PFpatJetsWithBtagging.userData.userFloats.src += ['akPu5PFNjettiness:tau1','akPu5PFNjettiness:tau2','akPu5PFNjettiness:tau3']
...
akPu5PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPu5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akPu5PFJetBtagging
                                                  *
                                                  #ppDataDummy_akPu5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
