...
#ppDataDummy_akVs2PFpatJetsWithBtagging.userData.userFloats.src += ['akVs2PFNjettiness:tau1','akVs2PFNjettiness:tau2','akVs2PFNjettiness:tau3']
...
akVs2PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVs2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akVs2PFJetBtagging
                                                  *
                                                  #ppDataDummy_akVs2PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
