...
#ppDataDummy_akPuFilter5CalopatJetsWithBtagging.userData.userFloats.src += ['akPuFilter5CaloNjettiness:tau1','akPuFilter5CaloNjettiness:tau2','akPuFilter5CaloNjettiness:tau3']
...
akPuFilter5CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter5CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter5CaloJetSequence_data = cms.Sequence(akPuFilter5Calocorr
                                                    ...
                                                    *
                                                    akPuFilter5CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter5CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter5CalopatJetsWithBtagging
                                                    *
                                                    akPuFilter5CaloJetAnalyzer
