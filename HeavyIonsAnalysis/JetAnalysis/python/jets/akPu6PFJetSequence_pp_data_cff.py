...
#ppDataDummy_akPu6PFpatJetsWithBtagging.userData.userFloats.src += ['akPu6PFNjettiness:tau1','akPu6PFNjettiness:tau2','akPu6PFNjettiness:tau3']
...
akPu6PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPu6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akPu6PFJetBtagging
                                                  *
                                                  #ppDataDummy_akPu6PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
