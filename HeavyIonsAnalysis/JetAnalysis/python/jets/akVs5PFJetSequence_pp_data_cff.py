...
#ppDataDummy_akVs5PFpatJetsWithBtagging.userData.userFloats.src += ['akVs5PFNjettiness:tau1','akVs5PFNjettiness:tau2','akVs5PFNjettiness:tau3']
...
akVs5PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVs5PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akVs5PFJetBtagging
                                                  *
                                                  #ppDataDummy_akVs5PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
