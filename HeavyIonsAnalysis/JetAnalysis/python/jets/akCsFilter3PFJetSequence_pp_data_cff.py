...
#ppDataDummy_akCsFilter3PFpatJetsWithBtagging.userData.userFloats.src += ['akCsFilter3PFNjettiness:tau1','akCsFilter3PFNjettiness:tau2','akCsFilter3PFNjettiness:tau3']
...
akCsFilter3PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akCsFilter3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akCsFilter3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akCsFilter3PFJetSequence_data = cms.Sequence(akCsFilter3PFcorr
                                                    ...
                                                    *
                                                    akCsFilter3PFJetBtagging
                                                    *
                                                    #ppDataDummy_akCsFilter3PFNjettiness 
                                                    #ppDataDummy_*
                                                    akCsFilter3PFpatJetsWithBtagging
                                                    *
                                                    akCsFilter3PFJetAnalyzer
