...
#ppDataDummy_akVs1PFpatJetsWithBtagging.userData.userFloats.src += ['akVs1PFNjettiness:tau1','akVs1PFNjettiness:tau2','akVs1PFNjettiness:tau3']
...
akVs1PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akVs1PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akVs1PFJetBtagging
                                                  *
                                                  #ppDataDummy_akVs1PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
