...
ak4PFJetSequence_mc = cms.Sequence(
			                          ...
			                          ak4PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  ak4PFJetBtagging
                                                  *
                                                  #ppDataDummy_ak4PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
