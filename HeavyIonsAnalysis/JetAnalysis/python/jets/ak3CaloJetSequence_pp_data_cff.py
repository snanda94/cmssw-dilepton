...
#ppDataDummy_ak3CalopatJetsWithBtagging.userData.userFloats.src += ['ak3CaloNjettiness:tau1','ak3CaloNjettiness:tau2','ak3CaloNjettiness:tau3']
...
ak3CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          ak3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  ak3CaloJetBtagging
                                                  *
                                                  #ppDataDummy_ak3CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
