...
#ppDataDummy_akPu3PFpatJetsWithBtagging.userData.userFloats.src += ['akPu3PFNjettiness:tau1','akPu3PFNjettiness:tau2','akPu3PFNjettiness:tau3']
...
akPu3PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPu3PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  akPu3PFJetBtagging
                                                  *
                                                  #ppDataDummy_akPu3PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
