...
#ppDataDummy_akVsFilter5CalopatJetsWithBtagging.userData.userFloats.src += ['akVsFilter5CaloNjettiness:tau1','akVsFilter5CaloNjettiness:tau2','akVsFilter5CaloNjettiness:tau3']
...
akVsFilter5CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akVsFilter5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akVsFilter5CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akVsFilter5CaloJetSequence_data = cms.Sequence(akVsFilter5Calocorr
                                                    ...
                                                    *
                                                    akVsFilter5CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akVsFilter5CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akVsFilter5CalopatJetsWithBtagging
                                                    *
                                                    akVsFilter5CaloJetAnalyzer
