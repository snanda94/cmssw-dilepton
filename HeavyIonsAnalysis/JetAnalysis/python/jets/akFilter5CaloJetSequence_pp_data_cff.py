...
akFilter5CaloJetSequence_mc = cms.Sequence(
			                          ...
			                          akFilter5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akFilter5CaloNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akFilter5CaloJetSequence_data = cms.Sequence(akFilter5Calocorr
                                                    ...
                                                    *
                                                    akFilter5CaloJetBtagging
                                                    *
                                                    #ppDataDummy_akFilter5CaloNjettiness 
                                                    #ppDataDummy_*
                                                    akFilter5CalopatJetsWithBtagging
                                                    *
                                                    akFilter5CaloJetAnalyzer
