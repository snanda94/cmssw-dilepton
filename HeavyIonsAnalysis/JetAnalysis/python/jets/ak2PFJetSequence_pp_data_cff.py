...
ak2PFJetSequence_mc = cms.Sequence(
			                          ...
			                          ak2PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  ak2PFJetBtagging
                                                  *
                                                  #ppDataDummy_ak2PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
