...
#ppDataDummy_akPuFilter6PFpatJetsWithBtagging.userData.userFloats.src += ['akPuFilter6PFNjettiness:tau1','akPuFilter6PFNjettiness:tau2','akPuFilter6PFNjettiness:tau3']
...
akPuFilter6PFJetSequence_mc = cms.Sequence(
			                          ...
			                          akPuFilter6PFPatJetFlavourId  # doesn't work for PbPb yet
                                                  ...
                                                  *
                                                  #ppDataDummy_akPuFilter6PFNjettiness #No constituents for calo jets in pp. Must be removed for pp calo jets but I'm not sure how to do this transparently (Marta)
                                                  #ppDataDummy_*
...
akPuFilter6PFJetSequence_data = cms.Sequence(akPuFilter6PFcorr
                                                    ...
                                                    *
                                                    akPuFilter6PFJetBtagging
                                                    *
                                                    #ppDataDummy_akPuFilter6PFNjettiness 
                                                    #ppDataDummy_*
                                                    akPuFilter6PFpatJetsWithBtagging
                                                    *
                                                    akPuFilter6PFJetAnalyzer
