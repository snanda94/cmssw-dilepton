...
oniaTreeAnalyzer(process, muonTriggerList={'DoubleMuonTrigger':"test", 'DoubleMuonFilter':"test", "SingleMuonTrigger":"test", "SingleMuonFilter":"test"}, HLTProName='HLT', muonSelection="Glb", useL1Stage2=True, isMC=False, pdgID=443, outputFileName="HiForestAOD.root")
