...
process = cms.Process('reHLT',eras.Run2_2016_pA)
...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring('root://eoscms//eos/cms/store/express/PARun2016A/ExpressPhysicsPA/FEVT/Express-v1/000/284/755/00000/34463D0D-D6A4-E611-898F-02163E0144CF.root')
)
...
process.GlobalTag = GlobalTag(process.GlobalTag, '80X_dataRun2_HLT_frozen_v13', '')
...
process.hltAna_step = cms.EndPath(
    ...
    process.hltGetRaw + 
    process.HLTL1UnpackerSequence + # L1 Muons
    process.HLTBeamSpot + 
...
massSearchReplaceAnyInputTag(process.hltAna_stepUNPACK,"rawDataCollector","rawDataCollector::LHC")
...
process.schedule.extend([process.hltAna_step,process.hltAna2,process.endjob_step])
