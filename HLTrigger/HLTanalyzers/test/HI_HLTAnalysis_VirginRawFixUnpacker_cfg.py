...
NEVTS=-1
MENU="HIon_VRFIXUNPACKER" # LUMI8e29 or LUMI1e31 for pre-38X MC, or GRun for data
...
process.load("HLTrigger.HLTanalyzers.HLT_HIon_VRFIXUNPACKER_cff")
...
process.load("HLTrigger.HLTanalyzers.HI_HLTopen_VRFIXUNPACKER_cff")
...
if (MENU == "HIon_VRFIXUNPACKER"):
    print "menu HIon VIRGIN RAW MODIFIED REGIONAL UNPACKER"
