...
process.load("HLTrigger.HLTanalyzers.HLT_HIon_RAW10REORDER_cff")
...
process.load("HLTrigger.HLTanalyzers.HI_HLTopen_RAW10REORDER_cff")
...
if (MENU == "HIon"):
    print "menu HIon Virgin Raw RAW10 REORDER Unpacker"
