...
HLTDoHILocalStripSequence = cms.Sequence( hltSiStripExcludedFEDListProducer + hltSiStripRawToDigi + hltSiStripZeroSuppression + hltHITrackingSiStripRawToClustersFacilityZeroSuppression + hltHISiStripClusters )
