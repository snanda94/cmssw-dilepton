...
virginRawDataRepackerReHLT = cms.EDProducer( "RawDataCollectorByLabel",
    verbose = cms.untracked.int32( 0 ),
    RawCollectionList = cms.VInputTag( 'hltSiStripRawDigiToVirginRaw' )
)
rawDataRepackerReHLT = cms.EDProducer( "RawDataCollectorByLabel",
    verbose = cms.untracked.int32( 0 ),
    RawCollectionList = cms.VInputTag( 'hltSiStripDigiToZSRaw','source', cms.InputTag("rawDataRepacker"))
)
...
HLTDoHIStripZeroSuppression = cms.Sequence( hltSiStripRawToDigi + hltSiStripZeroSuppression + hltSiStripDigiToZSRaw + hltSiStripRawDigiToVirginRaw + virginRawDataRepackerReHLT + rawDataRepackerReHLT )
...
HLTDoHIStripZeroSuppressionRepacker = cms.Sequence( hltSiStripDigiToZSRaw + hltSiStripRawDigiToVirginRaw + virginRawDataRepackerReHLT + rawDataRepackerReHLT )
