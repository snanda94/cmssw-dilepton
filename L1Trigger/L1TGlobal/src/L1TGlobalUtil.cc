...
l1t::L1TGlobalUtil::L1TGlobalUtil(edm::ParameterSet const& pset,
  ...
  m_algorithmTriggersUnprescaled = !pset.getUntrackedParameter<bool>("getPrescales",false);
  m_algorithmTriggersUnmasked = !pset.getUntrackedParameter<bool>("getPrescales",false);
}
