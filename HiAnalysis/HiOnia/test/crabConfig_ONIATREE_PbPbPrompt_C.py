...
config.General.requestName = 'HIOniaL1DoubleMu0C_HIRun2015-PromptReco-v1_GT_75X_dataRun2_v12_ONIATREE_20160420_2015CUT'
...
config.JobType.psetName = 'hioniaanalyzer_PbPbPrompt_C_cfg.py'
config.JobType.maxMemoryMB = 2500
config.JobType.outputFiles = ['OniaTree.root']

config.section_('Data')
config.Data.inputDataset = '/HIOniaL1DoubleMu0C/anstahll-HIOniaL1DoubleMu0C_HIRun2015-PromptReco-v1_Run_262548_263757_GT_75X_dataRun2_v12_ONIASKIM_v2-cee6823f638ce84fac6036a59c410634/USER'
