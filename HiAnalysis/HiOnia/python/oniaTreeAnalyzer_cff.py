...
###################### HiOnia Analyzer #################################################
    ...
    process.hionia = cms.EDAnalyzer('HiOniaAnalyzer',
                                    ...
                                    # HLT pPb TEST MENU:  /users/anstahll/PA2016/HIDileptonPA2016/V24
                                    
                                    dblTriggerPathNames = cms.vstring("HLT_PAL1DoubleMu0_MGT1_v1",
                                                                      "HLT_PAL1DoubleMuOpen_MGT1_v1",
                                    ...
                                    dblTriggerFilterNames = cms.vstring("hltL1fL1sDoubleMu0MassGT1BptxANDL1Filtered0",
                                                                        "hltL1fL1sDoubleMuOpenMassGT1BptxANDL1Filtered0",
                                                                        ...
                                                                        "hltL1fL1sDoubleMu10Mass60to150BptxANDL1Filtered0",
                                                                        "hltL2fL1sDoubleMuOpenBptxANDL1f0L2Filtered0",
                                                                        "hltL2fL1sDoubleMu10BptxANDL1f0L2Filtered10",
                                                                        "hltL2fL1sDoubleMu10Mass60to150BptxANDL1f0L2Filtered10",
                                                                        ...
                                                                        "hltHIL3fL1sDouble10BptxANDL1f0L2f10L3Filtered10",
                                                                        "hltL3fL1sDoubleMu10Mass60to150BptxANDL1f0L2f10L3Filtered10",
                                                                        "hltHIL3fL1sDoubleMu10Mass60to150BptxANDL1f0L2f10L3Filtered10",
                                                                        "hltL2fL1sDoubleMuOpenBptxANDL1f0L2Filtered3"),
                                    
                                    sglTriggerPathNames = cms.vstring("HLT_PAL1MuOpen_v1",
                                                                      "HLT_PAL1MuOpen_NoBptxAND_v1",
                                                                      "HLT_PAL1Mu0_v1",
                                                                      "HLT_PAL1Mu12_v1",
                                                                      "HLT_PAL1Mu15_v1",
                                                                      "HLT_PAL2Mu0_v1",
                                    ...
                                    sglTriggerFilterNames = cms.vstring("hltL1fL1sSingleMuOpenBptxANDL1Filtered0",
                                                                        "hltL1fL1sSingleMuOpenL1Filtered0",
                                                                        "hltL1fL1sSingleMuOpenBptxANDL1HighQFiltered0",
                                                                        "hltL1fL1sSingleMu7BptxANDL1Filtered12",
                                                                        "hltL1fL1sSingleMu7BptxANDL1Filtered15",
                                                                        "hltL2fL1sSingleMuOpenBptxANDL1HQf0L2Filtered0",
                                                                        "hltL2fL1sSingleMu7BptxANDL1f0L2Filtered12",
                                                                        "hltL2fL1sSingleMu7BptxANDL1f0L2Filtered15",
                                                                        "hltL3fL1sSingleMuOpenBptxANDL1HQf0L2f0L3Filtered0",
                                                                        "hltHIL3fL1sSingleMuOpenBptxANDL1HQf0L2f0L3Filtered0",
