# hltGetConfiguration /users/jaebeom/HLT_ppref --hilton --globaltag 92X_upgrade2017_realistic_v11 --input /store/user/gsfs/Pythia8_MinBias_pp_CUETP8M1_5020GeV/RAW_20171002/171003_010838/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_1.root --mc --process MYHLT --full --offline --l1-emulator FullMC --l1Xml L1Menu_Collisions2017_HI_draft_v3.xml --unprescale --max-events -1 --output none
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/user/gsfs/Pythia8_MinBias_pp_CUETP8M1_5020GeV/RAW_20171002/171003_010838/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_1.root',
    ),
...
_customInfo['inputFile' ]=  ['/store/user/gsfs/Pythia8_MinBias_pp_CUETP8M1_5020GeV/RAW_20171002/171003_010838/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_1.root']
...
process.hltbitanalysis.HLTProcessName              = "MYHLT"
process.hltbitanalysis.hltresults                  = cms.InputTag("TriggerResults","","MYHLT")
process.hltbitanalysis.l1tAlgBlkInputTag           = cms.InputTag("hltGtStage2Digis","","MYHLT")
process.hltbitanalysis.l1tExtBlkInputTag           = cms.InputTag("hltGtStage2Digis","","MYHLT")
process.hltbitanalysis.gObjectMapRecord            = cms.InputTag("hltGtStage2ObjectMap","","MYHLT")
...
process.hltbitanalysis.RunParameters.HistogramFile = cms.untracked.string("HltTree.root")
process.hltbitanalysis.RunParameters.isData        = cms.untracked.bool(False)
